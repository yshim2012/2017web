    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() < available_height) {
                /*content.attr('style', 'min-height:' + available_height + 'px !important');布局修改，高度固定-lwf20140813*/
            }
        } else {
            ...
            if (height >= content.height()) {
                /*content.attr('style', 'min-height:' + height + 'px !important');布局修改，高度固定-lwf20140813*/
            }
        }
    }
        ...
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if (sub.is(":visible")) {
                ...
                sub.slideUp(slideSpeed, function () {
                    ...
                    }由于布局已跟原来不一样，展开菜单时，不需要再滚动页面. by-lingweifeng-20140811*/
                    handleSidebarAndContentHeight();
                });
            } else {
